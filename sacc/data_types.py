...
required_tags = {
    ...
    "cmbGalaxy_convergenceShear_xi_minus": ['theta'],
    "cmbGalaxy_convergenceShear_xi_plus": ['theta'],
    ...
    "cmbGalaxy_temperatureShear_xi_tb": ['theta'],
    "cmbGalaxy_temperatureShear_xi_te": ['theta'],
